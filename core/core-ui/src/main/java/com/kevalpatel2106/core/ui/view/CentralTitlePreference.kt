package com.kevalpatel2106.core.ui.view
...
internal class CentralTitlePreference @JvmOverloads constructor(
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        (holder.findViewById(android.R.id.title) as? AppCompatTextView)?.layoutParams?.width =
            ViewGroup.LayoutParams.MATCH_PARENT
        (holder.findViewById(android.R.id.title) as? AppCompatTextView)?.gravity = Gravity.CENTER
        (holder.findViewById(android.R.id.summary) as? AppCompatTextView)?.layoutParams?.width =
            ViewGroup.LayoutParams.MATCH_PARENT
